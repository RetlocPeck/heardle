      ...
      <PageShell blobCount={2} subtle>
        <div className="flex items-center justify-center min-h-screen">
          <div className="relative z-10 text-center">
            <div className="backdrop-blur-xl theme-glass-surface rounded-3xl p-12 shadow-[var(--glass-shadow)]">
              <h1 className="text-5xl font-bold theme-text mb-6">Artist Not Found</h1>
              <p className="theme-text-secondary mb-8 text-lg">The artist you're looking for doesn't exist.</p>
              <a
                href="/"
                className="inline-block px-8 py-4 theme-btn-primary font-bold rounded-2xl transition-all duration-300 transform hover:scale-105"
              >
                ← Back to Home
              </a>
            </div>
        ...
        <div className="py-3 sm:py-4">
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2">
              <h1 className="text-xl sm:text-2xl md:text-3xl font-bold theme-text whitespace-nowrap">
          ...
          <div className="text-center">
            <p className="theme-text-secondary text-xs sm:text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
